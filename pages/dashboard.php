...
<body class="bg-content">
    <main class="dashboard d-flex">
        ...
        <?php 
            ...
            $nbr_pay = $con->query("SELECT Billnumber FROM payments_list");
            $nbr_pay = $nbr_pay->rowCount();
            ...
            <div class="cards row gap-3 justify-content-center mt-5">
                ...
                <div class=" card__items card__items--yellow col-md-3 position-relative">
                    ...
                    <div class="card__payments">
                        <span class="h5 fw-bold nbr"></span>
                        <span class="h5 fw-bold nbr"><?php echo $nbr_pay; ?></span>
                    </div>
                </div>
