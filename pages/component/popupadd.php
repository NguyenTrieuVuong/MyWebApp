<div class="button-add-student">
  <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo">Thêm sinh viên</button>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form method="POST" action="addstudent.php" enctype="multipart/form-data">
            ...
            <div class="">
              <label for="recipient-name" class="col-form-label">Ngày/tháng/năm sinh:</label>
