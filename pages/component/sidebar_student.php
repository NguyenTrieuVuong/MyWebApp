...
<div class="bg-sidebar vh-100 w-50 position-fixed">
    ...
    <div class=" bg-list d-flex flex-column align-items-center fw-bold gap-2 mt-4 ">
        <ul class="d-flex flex-column list-unstyled">
            <li class="h7"><a class=" nav-link text-dark" href="dashboard_student.php"><i class="fal fa-home-lg-alt me-2"></i> <span>Trang Chủ</span></a></li>
            <li class="h7"><a class=" nav-link text-dark" href="course_student.php"><i class="fal fa-bookmark me-2"></i> <span>Khóa Học</span></a></li>
